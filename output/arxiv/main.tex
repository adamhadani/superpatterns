...
Section 2 analyzes the continuous Poisson jump generator of the repeated-$21$ frontier and establishes Theorem 1.4. Section 3 covers the canonical skeletal decomposition for bounding partition entropy. Section 4 introduces flexible lookahead interfaces to resolve the Poisson void obstruction. Section 5 establishes simultaneous universality at $C_0 k^2$ for bounded-LDS classes (Theorem 1.1). Section 6 proves the sharp universality for modular interval inflations (Theorem 1.3). Section 7 characterizes the sharp $1/4$ frontier, establishing the bounded-LDS splittings, and full generic bulk synthesis via permuton bundles and coordinate track buffers (Theorems 1.2, 1.5, and 1.6). Finally, Section 8 summarizes the formal verification of our core results in Lean 4.
