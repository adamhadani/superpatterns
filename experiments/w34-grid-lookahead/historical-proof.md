# Historical draft — superseded on 2026-09-10

This file preserves the original argument, including claims withdrawn or repaired in `proof.md`. Do not cite it as the current proof.
