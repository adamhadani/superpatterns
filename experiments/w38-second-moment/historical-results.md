# Historical numerical interpretation — superseded 2026-09-10

Several asymptotic claims below were unsupported. Use `results.md` and the new diagnostic for current conclusions. Raw historical measurements remain useful.
